...
class ManufacturerTools(BaseTools):
    ...
    def __register_mcp_tools__(cls, mcp: FastMCP) -> None:
        ...
        @mcp.tool(name="get_tyre_manufacturers")
        async def get_tyre_manufacturers() -> json:
            """
            Get every tyre manufacturer:
                id, str
                name, str
                country_id, str
            """
        ...
        @mcp.tool(name="get_engine_manufacturers")
        async def get_engine_manufacturers() -> json:
            """
            Get every engine manufacturer:
                id, str
                name, str
                country_id, str
            """
